...
void calc(string word)
{
	bool check = ispalindrom(word);
	if (!check)
	{
		return;
	}
...
void MakeSubsequence(string word)
{
	int n = word.size();
	for (int i = 0; i < (1 << n); i++)
	{
